...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "g3dkvrs78k9fwum8erq0pcrdmrvj4tjqppfpg36d7z2s9dhmkk9h",
  ...
  manifest = (
    ...
    appTitle = (defaultText = "Test App: scheduling API"),
    ...
    actions = [
      ...
      ( nounPhrase = (defaultText = "hourly job"),
        command = .hourlyCmd
        # The command to run when starting for the first time. (".myCommand"
        # is just a constant defined at the bottom of the file.)
      ),
      ( nounPhrase = (defaultText = "one-shot job"),
        command = .oneShotCmd
      )
    ],
    ...
    metadata = (
      ...
      shortDescription = (defaultText = "Test the scheduling API"),
...
const hourlyCmd :Spk.Manifest.Command = (
  argv = ["/app", "hourly"],
  environ = .cmdEnv
);

const oneShotCmd :Spk.Manifest.Command = (
  argv = ["/app", "oneShot"],
  environ = .cmdEnv
);
